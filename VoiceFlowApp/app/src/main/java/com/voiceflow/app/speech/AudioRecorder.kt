 ...
 * Equivalent to recorder.py from OpenVoiceFlow.
 *
...
class AudioRecorder(private val context: Context) {
    ...
    /**
     * Start recording audio. Records PCM data in the background
    ...
    private fun createWav(pcmData: ByteArray): ByteArray {
        ...
        dos.writeIntLE(SAMPLE_RATE) // sample rate
        dos.writeIntLE(byteRate)    // byte rate
        dos.writeShortLE(blockAlign)// block align
    ...
    // Little-endian write helpers (WAV uses little-endian)
